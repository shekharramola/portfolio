                ...
                <div className="row">
                    ...
                    <div className="reference">
                      ...
                      >
                        <p>
                          ...
                          complete the steps from initiating to disbursing and finally closing the loan.
                        </p>
                  ...
                  >
                    <div className="reference">
                      ...
                      >
                        <p>
                        It is a incentive system to automate the incentive process of the employees.
                        </p>
                  ...
                  >
                    <div className="reference">
                      ...
                      >
                        <p>
                        It is an operational application for the payment system.
                        </p>
                  ...
                  >
                    <div className="reference">
                      <a href="#">
                        ...
                        <div className="overlay">
                          <div className="inner">
                            <h3 className="h4 reference-title">Reddit Web Client</h3>
                            <p>It is a replica of reddit web app with enhanced design</p>
                          </div>
                        </div>
                      </a>
                      <div
                  ...
                  >
                    <div className="reference">
                      <a href="#">
                        ...
                        <div className="overlay">
                          <div className="inner">
                            <h3 className="h4 reference-title">Burger Builder</h3>
                      ...
                      <a href="#">
                        ...
                        <div className="overlay">
                          <div className="inner">
                            ...
                            <p>Payment system for customer to send and receive bitcoins.</p>
                          </div>
                        </div>
                      </a>
                      <div
                  ...
                  >
                    <div className="reference">
                      ...
                      >
                        <p>
                          It tells the  current price of steel product around the world and also predict the value.
                        </p>
